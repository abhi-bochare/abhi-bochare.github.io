$(document).ready(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    emailjs.init("legqXVdntryA6iwnS"); // Initialize Email.js with your API key
    ...
    document
      ...
      .addEventListener("click", function (event) {
        ...
        if (name && email && phone && message) {
          ...
          var serviceID = "service_lxeug5h"; // Your Email Service ID
          var templateID = "template_b9t83kw"; // Your Email Template ID
...
document.addEventListener("visibilitychange", function () {
  if (document.visibilityState === "visible") {
    document.title = "Portfolio | Abhishek Bochare";
    $("#favicon").attr("href", "assets/img/hero-img.png");
  } else {
...
contactPhoneIcon.addEventListener("click", function () {
  window.location.href = "tel:9623910270";
});
